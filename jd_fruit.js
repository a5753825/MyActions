...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: "https://github.com/a5753825/RandomShareCode/raw/main/JD_Fruit.json",headers:{
      ...
      try {
        if (err) {
          ...
          $.get({url: `https://github.com/a5753825/RandomShareCode/raw/main/JD_Fruit.json`, 'timeout': 10000},(err, resp, data)=>{
